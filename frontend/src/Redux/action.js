...
export const getProducts = (category) => (dispatch) => {
  ...
  axios
    .get(`https://bewakoof12.vercel.app/prod/${category}`, {
...
export const getUserbag = (id) => (dispatch) => {
  ...
  axios
    .get(`https://bewakoof12.vercel.app/users/cart/${id}`, {
      withCredentials: true,
      headers: {
        Authorization: token,
      },
...
export const getUserWish = (id) => (dispatch) => {
  ...
  axios
    .get(`https://bewakoof12.vercel.app/users/wishlisht/${id}`, {
      withCredentials: true,
      headers: {
        Authorization: token,
      },
...
export const changeQty = (productId, qty, id) => (dispatch) => {
  ...
  axios
    .patch(
      `https://bewakoof12.vercel.app/users/qty/${id}`,
      {
        productId,
        qty,
      },
...
export const doRemove = (productId, id) => (dispatch) => {
  ...
  axios
    .patch(
      `https://bewakoof12.vercel.app/users/removeProduct/${id}`,
      { productId },
      {
        withCredentials: true,
        headers: {
...
export const wishRemove = (productId, id) => (dispatch) => {
  ...
  axios
    .patch(
      `https://bewakoof12.vercel.app/users/removeWish/${id}`,
      { productId },
      {
        withCredentials: true,
        headers: {
...
export const AddToWish = (productId, id, error, notify) => (dispatch) => {
  ...
  axios
    .patch(
      `https://bewakoof12.vercel.app/users/addToWishlist/${id}`,
      { productId },
      {
        withCredentials: true,
        headers: {
...
export const orderbag = (id) => (dispatch) => {
  ...
  axios
    .patch(
      `https://bewakoof12.vercel.app/users/order/${id}`,
      {},
      {
        withCredentials: true,
        headers: {
...
export const getSingleProd = (id) => (dispatch) => {
  ...
  axios
    .get(`https://bewakoof12.vercel.app/product/${id}`, {
      withCredentials: true,
      headers: {
        Authorization: token,
      },
...
export const addDataToCart =
  (id, productId, size, error, notify) => (dispatch) => {
    ...
    axios
      .patch(
        `https://bewakoof12.vercel.app/users/addToCart/${id}`,
        { productId, size },
        {
          withCredentials: true,
          headers: {
...
export const getUser = () => (dispatch) => {
  ...
  axios
    .get("https://bewakoof12.vercel.app/users/verify", {
      withCredentials: true,
      headers: {
        Authorization: token,
      },
